 ...
 * @ORM\Entity(repositoryClass="OfferBundle\Repository\UserRepository")
 */
class User implements UserInterface
{
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="OfferBundle\Entity\Role")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="OfferBundle\Entity\Article", mappedBy="author")
     */
    private $articles;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="OfferBundle\Entity\Comment", mappedBy="user")
     */
    private $comments;
